...
#' @usage CBWWorkshop2024::NCI_ALMANAC_raw
#' @keywords datasets
...
#' @usage CBWWorkshop2024::NCI60_molecular_data
#' @keywords datasets
...
#' @usage CBWWorkshop2024::NCI_ALMANAC_sample_metadata
#' @keywords datasets
#' @format `data.frame` object
"NCI_ALMANAC_sample_metadata"
...
#'
#' @docType data
#' @name NCI_ALMANAC_treatment_metadata
#' @usage data(NCI_ALMANAC_treatment_metadata)
#' @usage CBWWorkshop2024::NCI_ALMANAC_treatment_metadata
#' @keywords datasets
#' @format `data.frame` object
...
#' 
#' @docType data
#' @name NCI_ALMANAC_pset
#' @usage data(NCI_ALMANAC_pset) 
#' @usage CBWWorkshop2024::NCI_ALMANAC_pset
#' @format `PharmacoSet` object
#' \describe{
#'  \item{sample}{60 samples}
#'  \item{treatment}{31 treatments}
#'  \item{molecularProfiles}{A `MultiAssayExperiment` with 4 
#'  `RangedSummarizedExperiments`, 'rna', 'mirna', 'rnaseq.comp', and 'rnaseq.iso'}
#'  \item{treatmentResponse}{A `TreatmentResponseExperiment` with 10080 total
#'  experiments. Assays are: 'response', 'profiles' and 'assay_metadata'.
#'  }
#' }
#' @keywords datasets
"NCI_ALMANAC_pset"
